...
import Pages.Remittances_DetailsOfSearchedRemittancesPage;
import Pages.Remittances_HomePage;
import Pages.Remittances_LoginPage;
import Pages.Remittances_SearchedRemittancesPage;
...
public class Remittances_RefundingRemittancetest extends Remittances_TestBase {
    ...
    public void userCanCashOutRemittancesSuccessfully() throws InterruptedException 
    {
		...
		remittances_DetailsOfSearchedRemittancesObject.refundRemittance();
