...
public class CashCollection_AddNewCashCollectiontest_Config1 extends CashCollections_TestBase{
	...
	String CompanyName = "درباله تيست 1";
	...
	public void userCanAddNewCashCollectionSuccessfully() throws InterruptedException, AWTException 
	{
	    ...
	    double expectedPayedValue = Double.parseDouble(CashAmount) + Double.parseDouble(ChangeAmount);
