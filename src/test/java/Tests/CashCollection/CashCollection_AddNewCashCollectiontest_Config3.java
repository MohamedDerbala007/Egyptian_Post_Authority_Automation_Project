...
public class CashCollection_AddNewCashCollectiontest_Config3 extends CashCollections_TestBase{
	...
	String CompanyName = "درباله تيست 3";
	...
	public void userCanAddNewCashCollectionSuccessfully() throws InterruptedException, AWTException 
	{
	    ...
	    double expectedPayedValue = Double.parseDouble(CashAmount) + Double.parseDouble(ChangeAmount) + actualServiceFee;
