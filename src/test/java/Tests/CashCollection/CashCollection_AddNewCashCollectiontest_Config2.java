...
public class CashCollection_AddNewCashCollectiontest_Config2 extends CashCollections_TestBase{
	...
	String CompanyName = "درباله تيست 2";
	...
	public void userCanAddNewCashCollectionSuccessfully() throws InterruptedException, AWTException 
	{
		...
		double expectedChangeFees = 0.002 * Double.parseDouble(ChangeAmount);
	    double actualChangeFees = Double.parseDouble(displayedChangeFeesAmount);
	    double expectedPayedValue = Double.parseDouble(CashAmount) + Double.parseDouble(ChangeAmount) + actualChangeFees;
